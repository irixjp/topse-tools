...
ssh -o StrictHostKeyChecking=no root@10.10.10.201 'crudini --set /etc/nova/nova.conf DEFAULT cpu_allocation_ratio 32'
ssh -o StrictHostKeyChecking=no root@10.10.10.201 'crudini --set /etc/nova/nova.conf DEFAULT ram_allocation_ratio 16'
ssh -o StrictHostKeyChecking=no root@10.10.10.201 'crudini --set /etc/nova/nova.conf DEFAULT disk_allocation_ratio 12'
...
ssh -o StrictHostKeyChecking=no root@10.10.10.202 'crudini --set /etc/nova/nova.conf DEFAULT cpu_allocation_ratio 32'
ssh -o StrictHostKeyChecking=no root@10.10.10.202 'crudini --set /etc/nova/nova.conf DEFAULT ram_allocation_ratio 16'
ssh -o StrictHostKeyChecking=no root@10.10.10.202 'crudini --set /etc/nova/nova.conf DEFAULT disk_allocation_ratio 12'
